...
using CarsGallery.ResourceOwner.Web;
using CarsGallery.ResourceOwner.Web.Models;
...
namespace Microsoft.AspNet.Identity 
{
    public static class IdentityExtensions 
    {
        ...
        public static string GetUserId(this IIdentity identity) 
        {
            ...
            if (ci != null) 
            {
                return ci.FindFirstValue(CarsGallery.ResourceOwner.Web.IdentityConfig.UserIdClaimType);
            }
            return String.Empty;
        }
