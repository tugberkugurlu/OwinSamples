...
using CarsGallery.ResourceServer.Web;
using CarsGallery.ResourceServer.Web.Models;
...
namespace Microsoft.AspNet.Identity 
{
    public static class IdentityExtensions 
    {
        ...
        public static string GetUserId(this IIdentity identity) 
        {
            ...
            if (ci != null) 
            {
                return ci.FindFirstValue(CarsGallery.ResourceServer.Web.IdentityConfig.UserIdClaimType);
            }
            return String.Empty;
        }
